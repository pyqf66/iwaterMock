...
(function($) {
	function _1(_2) {
		...
		function _6(_10) {
			...
			var _12 = $("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>")
					.appendTo(_11);
			var tr = _12.find("tr");
	...
	$.fn.datebox.methods = {
		...
		initValue : function(jq, _2a) {
			return jq.each(function() {
						...
						var _2c = _2b.value;
						if (_2c) {
							_2c = _2b.formatter.call(this, _2b.parser.call(
											this, _2c));
						}
