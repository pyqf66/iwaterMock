...
(function($) {
	...
	$.mobile = {
		...
		init : function(_6) {
			...
			$(document).unbind(".mobile").bind("click.mobile", function(e) {
				...
				if (a.length) {
					var _8 = $.parser.parseOptions(a[0], ["animation",
									"direction", {
										back : "boolean"
									}]);
					if (_8.back) {
	...
	$.map(	["validatebox", "textbox", "filebox", "searchbox", "combo",
					"combobox", "combogrid", "combotree", "datebox",
					"datetimebox", "numberbox", "spinner", "numberspinner",
