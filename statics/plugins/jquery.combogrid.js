...
(function($) {
	...
	function _15(_1c, _1d, _1e) {
		...
		for (var i = 0; i < _1d.length; i++) {
			...
			ss.push(_2b(_29, _21.datagrid("getRows"))
					|| _2b(_29, _21.datagrid("getSelections"))
					|| _2b(_29, _20.mappingRows) || _29);
		}
	...
	function _2f(_30, q) {
		...
		if (_32.mode == "remote") {
			...
			_33.datagrid("load", $.extend({}, _32.queryParams, {
								q : q
							}));
		} else {
			if (!q) {
	...
	$.fn.combogrid.parseOptions = function(_45) {
		var t = $(_45);
		return $.extend({}, $.fn.combo.parseOptions(_45), $.fn.datagrid
						.parseOptions(_45), $.parser.parseOptions(_45, [
	...
	$.fn.combogrid.defaults = $.extend({}, $.fn.combo.defaults,
			$.fn.datagrid.defaults, {
				...
				filter : function(q, row) {
					...
					return (row[_46.textField] || "").toLowerCase().indexOf(q
							.toLowerCase()) == 0;
				}
			});
})(jQuery);
