...
(function($) {
		...
		function _1d() {
			if (_1b.noheader || (!_1b.title && !_1b.header)) {
				...
				if (_1b.header) {
					...
					if (!_22.length) {
						_22 = $("<div class=\"panel-header\"></div>")
								.prependTo(_1c);
					}
					if (!$.isArray(_1b.tools)) {
						_22.find("div.panel-tool .panel-tool-a")
								.appendTo(_1b.tools);
					}
					_22.empty();
					var _23 = $("<div class=\"panel-title\"></div>")
							.html(_1b.title).appendTo(_22);
					if (_1b.iconCls) {
						_23.addClass("panel-with-icon");
						$("<div class=\"panel-icon\"></div>")
								.addClass(_1b.iconCls).appendTo(_22);
					}
					var _24 = $("<div class=\"panel-tool\"></div>")
							.appendTo(_22);
						...
						if ($.isArray(_1b.tools)) {
							...
							$(_1b.tools).children().each(function() {
								$(this).addClass($(this).attr("iconCls"))
										.addClass("panel-tool-a").appendTo(_24);
							});
						}
					}
					if (_1b.collapsible) {
				...
				_1c.children("div.panel-body")
						.removeClass("panel-body-noheader");
			}
		};
		function _25(c, _26, _27) {
			var a = $("<a href=\"javascript:void(0)\"></a>").addClass(_26)
					.appendTo(c);
			a.bind("click", _27);
		};
		function _1e() {
	...
	function _28(_29, _2a) {
		...
		if (!_2b.isLoaded || !_2c.cache) {
			...
			if (_2c.loadingMessage) {
				$(_29).html($("<div class=\"panel-loading\"></div>")
						.html(_2c.loadingMessage));
			}
	...
	function _34(_35, _36) {
		...
		function cb() {
			_37.closed = false;
			_37.minimized = false;
			var _39 = _38.children(".panel-header")
	...
	$.fn.panel = function(_66, _67) {
		...
		return this.each(function() {
					...
					if (_68) {
						...
						_69 = $.extend({}, $.fn.panel.defaults, $.fn.panel
										.parseOptions(this), _66);
						$(this).attr("title", "");
						_68 = $.data(this, "panel", {
									options : _69,
									panel : _14(this),
			...
			return jq.each(function() {
				...
				function _72(_73, _74) {
					...
					var s = $(_73)
							...
							.filter(function(_76, el) {
								var p = $(el).parents(".panel-" + _74
										+ ":first");
	...
	$.fn.panel.parseOptions = function(_7a) {
		...
		return $.extend({}, $.parser.parseOptions(_7a, ["id", "width",
