...
(function($) {
	...
	function _19(_1a, _1b, el) {
		...
		_22.resizable($.extend({}, {
			...
			onStartResize : function(e) {
				...
				if (dir == "north") {
					pos.top = parseInt(_22.css("top")) + _22.outerHeight()
							- _23.height();
			...
			onResize : function(e) {
				if (dir == "north" || dir == "south") {
					...
					_27.css("top", e.pageY - $(_1a).offset().top - _27.height()
									/ 2);
				} else {
					var _27 = $(">div.layout-split-proxy-h", _1a);
					_27.css("left", e.pageX - $(_1a).offset().left
									- _27.width() / 2);
				}
				return false;
			},
	...
	function _28(_29, _2a) {
		...
		if (_2b[_2a].length) {
			...
			_2b[_2a] = $();
			var _2c = "expand" + _2a.substring(0, 1).toUpperCase()
					+ _2a.substring(1);
			if (_2b[_2c]) {
	...
	function _2d(_2e, _2f, _30) {
		...
		var _33 = "expand" + _2f.substring(0, 1).toUpperCase()
				+ _2f.substring(1);
		if (!_31[_33]) {
			_31[_33] = _34(_2f);
		...
		function _34(dir) {
			...
			p.panel($.extend({}, $.fn.layout.paneldefaults, {
						...
						title : "&nbsp;",
						iconCls : (_32.hideCollapsedContent
								? null
								: _32.iconCls),
						closed : true,
						minWidth : 0,
			...
			if (!_32.hideCollapsedContent) {
				var _3b = typeof _32.collapsedContent == "function"
						? _32.collapsedContent.call(p[0], _32.title)
						: _32.collapsedContent;
				...
				if (_2f == "west") {
					...
					if (_2f == "north") {
						...
						if (!_a(_31.expandNorth)) {
							hh += _40 - _3d
									+ ((_32.split || !_32.border) ? 1 : 0);
						}
						_31.east.add(_31.west).add(_31.expandEast)
								.add(_31.expandWest).panel("resize", {
											top : _3d - 1,
											height : hh
										});
						return {
	...
	function _41(_42, _43) {
		...
		var _46 = "expand" + _43.substring(0, 1).toUpperCase()
				+ _43.substring(1);
		if (_44[_46]) {
			_44[_46].panel("close");
	...
	$.fn.layout = function(_57, _58) {
		...
		return this.each(function() {
					...
					if (_59) {
						...
						var _5a = $.extend({}, $.fn.layout.defaults,
								$.fn.layout.parseOptions(this), _57);
						$.data(this, "layout", {
									options : _5a,
									panels : {
										center : $(),
	...
	$.fn.layout.parsePanelOptions = function(_68) {
		var t = $(_68);
		return $.extend({}, $.fn.panel.parseOptions(_68), $.parser
						.parseOptions(_68, ["region", {
											split : "boolean",
