...
(function($) {
							...
							if (t.hasClass("calendar-nextmonth")) {
								...
								if (t.hasClass("calendar-text")) {
									...
									if (t.hasClass("calendar-day")) {
										...
										if (!_11
												|| _11.getTime() != _b.current
														.getTime()) {
											_b.onChange.call(_a, _b.current,
													_11);
										}
	...
	function _5(_1a) {
		...
		if ($(_1a).find(".calendar-menu-month-inner").is(":empty")) {
			...
			var t = $("<table class=\"calendar-mtable\"></table>")
					.appendTo($(_1a).find(".calendar-menu-month-inner"));
			var idx = 0;
			for (var i = 0; i < 3; i++) {
	...
	function _19(_2f) {
		...
		var _31 = now.getFullYear() + "," + (now.getMonth() + 1) + ","
				+ now.getDate();
		var _32 = _30.current
				? (_30.current.getFullYear() + ","
						+ (_30.current.getMonth() + 1) + "," + _30.current
						.getDate())
				: "";
		...
		$(_2f).find(".calendar-title span").html(_30.months[_30.month - 1]
				+ " " + _30.year);
