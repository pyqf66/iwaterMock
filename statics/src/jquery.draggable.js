...
(function($) {
	...
	$.fn.draggable.parseOptions = function(target) {
		var t = $(target);
		return $.extend({}, $.parser.parseOptions(target, ['cursor', 'handle',
								'axis', {
									'revert' : 'boolean',
									'deltaX' : 'number',
									'deltaY' : 'number',
	...
	$.fn.draggable.defaults = {
		proxy : null, // 'clone' or a function that will create the proxy
		// object,
		// the function has the source parameter that indicate the source object
		// dragged.
		revert : false,
		cursor : 'move',
		deltaX : null,
