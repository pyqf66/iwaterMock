...
(function($) {
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
						...
						_53.find("div.combobox-item-selected")
								.removeClass("combobox-item-selected");
					});
		},
		reset : function(jq) {
	...
	$.fn.combobox.parseOptions = function(_59) {
		var t = $(_59);
		return $
				.extend({}, $.fn.combo.parseOptions(_59), $.parser
								.parseOptions(_59, ["valueField", "textField",
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
		...
		finder : {
			...
			getRow : function(_6c, p) {
				...
				var _6e = (p instanceof jQuery) ? p.attr("id")
						.substr(_6d.itemIdPrefix.length + 1) : _2(_6c, p);
