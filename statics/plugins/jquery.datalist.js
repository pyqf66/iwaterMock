...
(function($) {
	function _1(_2) {
		...
		$(_2).datagrid($.extend({}, _3, {
			...
			frozenColumns : (_3.frozenColumns && _3.frozenColumns.length)
					? _3.frozenColumns
					: (_3.checkbox ? [[{
								field : "_ck",
								checkbox : true
	...
	var _7 = $.extend({}, $.fn.datagrid.defaults.view, {
				render : function(_8, _9, _a) {
					...
					if (_c.groupField) {
						...
						for (var i = 0; i < g.groups.length; i++) {
							_d.push(this.renderGroup.call(this, _8, i,
									g.groups[i], _a));
						}
						$(_9).html(_d.join(""));
					} else {
				...
				renderGroup : function(_e, _f, _10, _11) {
					...
					if (!_11) {
						...
						_15.push(_13.groupFormatter.call(_e, _10.value,
								_10.rows));
						_15.push("</span>");
					}
					_15.push("</div>");
					_15.push(this
							.renderTable(_e, _10.startIndex, _10.rows, _11));
					return _15.join("");
				},
	...
	$.fn.datalist = function(_20, _21) {
		...
		return this.each(function() {
					...
					if (_23) {
						...
						var _24 = $.extend({}, $.fn.datalist.defaults,
								$.fn.datalist.parseOptions(this), _20);
	...
	$.fn.datalist.parseOptions = function(_26) {
		return $.extend({}, $.fn.datagrid.parseOptions(_26), $.parser
						.parseOptions(_26, ["valueField", "textField",
										"groupField", {
											checkbox : "boolean",
											lines : "boolean"
										}]));
	...
	$.fn.datalist.parseData = function(_27) {
		...
		$(_27).children().each(function() {
					...
					var row = {};
					var _2b = $(this).html();
					row[_28.valueField] = _2a.value != undefined
							? _2a.value
							: _2b;
