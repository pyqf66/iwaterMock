...
(function($) {
				...
				if (!$("#datagrid-group-style").length) {
					$("head")
							.append("<style id=\"datagrid-group-style\">"
									...
									+ Math.floor((_34.groupHeight - 16) / 2)
	...
	$.extend(_18, {
		refreshGroupTitle : function(_46, _47) {
			...
			var _4b = dc.body2.children("div.datagrid-group[group-index=" + _47
		...
		insertRow : function(_4c, _4d, row) {
			...
			if (_50) {
				...
				_50 = {
					value : row[_4f.groupField],
					rows : [row],
					startIndex : _4e.data.rows.length
				};
				_51 = this.groups.length;
				dc.body1.append(this.renderGroup
						.call(this, _4c, _51, _50, true));
				dc.body2.append(this.renderGroup.call(this, _4c, _51, _50,
						false));
		...
		updateRow : function(_57, _58, row) {
			...
			var tb = _59.finder.getTr(_57, _58, "body", 2)
		...
		deleteRow : function(_5b, _5c) {
			...
			var tb = _5e.finder.getTr(_5b, _5c, "body", 2)
					.closest("table.datagrid-btable");
			...
			if (_61.rows.length > 1) {
				...
				_5f.children("div.datagrid-group[group-index=" + _60 + "]")
						.remove();
				for (var i = _60 + 1; i < this.groups.length; i++) {
					_5f.children("div.datagrid-group[group-index=" + i + "]")
