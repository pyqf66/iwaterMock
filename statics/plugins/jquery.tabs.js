...
(function($) {
	...
	function _d(_e) {
		...
		if (_f.tools) {
			if (typeof _f.tools == "string") {
				...
				var _11 = $("<div class=\"tabs-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>")
						.appendTo(_10);
				var tr = _11.find("tr");
	...
	function _13(_14, _15) {
		...
		if (_17.tabPosition == "left" || _17.tabPosition == "right") {
			...
			_18.add(_19)._size("height",
					isNaN(parseInt(_17.height)) ? "" : cc.height());
			...
			ul._outerHeight(ul.outerHeight() - ul.height() - 1 + _17.tabHeight)
					.css("width", "");
			_19._size("height", isNaN(parseInt(_17.height))
							? ""
							: (cc.height() - _18.outerHeight()));
		...
		if (_16.tabs.length) {
			...
			$.map(_16.tabs, function(p) {
						_1d(p,	(_17.justified && $.inArray(_17.tabPosition, [
												"top", "bottom"]) >= 0)
										? _1c
										: undefined);
					});
	...
	function _2e(_2f) {
		...
		$(_2f).children("div.tabs-header").unbind().bind("click", function(e) {
						...
						if ($(e.target).hasClass("tabs-scroller-right")) {
							...
							if (a.length) {
								...
								if (li.length) {
									...
									if (_34.collapsible) {
										_34.closed ? _50(_2f, _33) : _75(_2f,
												_33);
									} else {
										_50(_2f, _33);
									}
			...
			if (li.length) {
				_31.onContextMenu.call(_2f, e, li.find("span.tabs-title")
								.html(), _32(li));
			}
		});
		function _32(li) {
	...
	function _36(_37) {
		...
		_39.removeClass("tabs-header-narrow").addClass(_38.narrow
				? "tabs-header-narrow"
				: "");
		...
		_3b.removeClass("tabs-justified").addClass(_38.justified
				? "tabs-justified"
				: "");
		if (_38.border == true) {
	...
	function _3c(_3d, _3e, pp) {
		...
		pp.panel($.extend({}, _3e, {
					...
					onOpen : function() {
						...
						_3f.options.onSelect.call(_3d, _48.title,
								_4a(_3d, this));
					},
					...
					onClose : function() {
						...
						_3f.options.onUnselect.call(_3d, _49.title, _4a(_3d,
										this));
					}
				}));
		$(_3d).tabs("update", {
	...
	$.fn.tabs.parseOptions = function(_97) {
		return $.extend({}, $.parser.parseOptions(_97, ["tools",
