...
(function($) {
	...
	function _1d(_1e) {
		...
		if (_23.closed) {
			...
			_21.panel("resize", {
						width : (_22.panelWidth ? _22.panelWidth : _20
								._outerWidth()),
		...
		function _24() {
			...
			if (_26 + _21._outerWidth() > $(window)._outerWidth()
					+ $(document).scrollLeft()) {
				_26 = $(window)._outerWidth() + $(document).scrollLeft()
						- _21._outerWidth();
			}
			if (_26 < 0) {
				_26 = 0;
		...
		function _25() {
			...
			if (top + _21._outerHeight() > $(window)._outerHeight()
					+ $(document).scrollTop()) {
	...
	function _32(_33, _34) {
		...
		for (var i = 0; i < _34.length; i++) {
			var _3a = $("<input type=\"hidden\" class=\"textbox-value\">")
					.appendTo(_37);
			_3a.attr("name", _39);
			if (_36.disabled) {
					...
					if (_49) {
						...
						_49 = $.data(this, "combo", {
									options : $.extend({}, $.fn.combo.defaults,
											$.fn.combo.parseOptions(this), _46),
									previousText : ""
								});
