...
(function($) {
	...
	function _5(_6) {
		...
		if (_8.buttonText || _8.buttonIcon) {
			var _9 = $("<a href=\"javascript:void(0)\" class=\"textbox-button\"></a>")
					.prependTo(tb);
	...
	function _e(_f, _10) {
		...
		_16.css({
					left : (_12.iconAlign == "left"
							? (_12.buttonAlign == "left"
									? btn._outerWidth()
									: 0)
							: ""),
					right : (_12.iconAlign == "right"
							? (_12.buttonAlign == "right"
									? btn._outerWidth()
									: 0)
							: "")
				});
	...
	function _b(_32, _33) {
		...
		_34.textbox.removeClass("textbox-readonly").addClass(_35.readonly
				? "textbox-readonly"
				: "");
