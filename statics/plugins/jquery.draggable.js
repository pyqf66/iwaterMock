...
(function($) {
	...
	$.fn.draggable = function(_20, _21) {
		...
		return this.each(function() {
					...
					if (_23) {
						...
						_22 = $.extend({}, $.fn.draggable.defaults,
								$.fn.draggable.parseOptions(this), _20 || {});
					}
					var _24 = _22.handle ? (typeof _22.handle == "string" ? $(
							_22.handle, this) : _22.handle) : $(this);
					$.data(this, "draggable", {
								options : _22,
								handle : _24
							});
					...
					_24.unbind(".draggable").bind("mousemove.draggable", {
								target : this
							}, function(e) {
								if ($.fn.draggable.isDragging) {
									return;
	...
	$.fn.draggable.parseOptions = function(_30) {
		var t = $(_30);
		return $.extend({}, $.parser.parseOptions(_30, ["cursor", "handle",
								"axis", {
									"revert" : "boolean",
									"deltaX" : "number",
									"deltaY" : "number",
