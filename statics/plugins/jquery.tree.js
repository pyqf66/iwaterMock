...
(function($) {
			...
			if (ck.hasClass("tree-checkbox1")) {
				...
				if (ck.hasClass("tree-checkbox0")) {
					...
					if (_3a._checked == undefined) {
						_3a._checked = $(_36).find(".tree-checkbox")
			...
			if (ck.length) {
				...
				if (_54.onlyLeafCheck) {
					$("<span class=\"tree-checkbox tree-checkbox0\"></span>")
							.insertBefore(_55.find(".tree-title"));
				}
			}
		} else {
			var ck = _55.find(".tree-checkbox");
	...
	function _5b(_5c, ul, _5d, _5e) {
		...
		if (!_5e) {
			...
			if (_62) {
				_62.children
						? _62.children = _62.children.concat(_5d)
						: _62.children = _5d;
			} else {
	...
	function _6b(_6c, ul, _6d) {
		...
		var _73 = $(ul).children("li:last").children("div.tree-node")
				.addClass("tree-node-last");
		_73.children("span.tree-join").removeClass("tree-join")
		...
		if (c[0].tagName != "BODY") {
			...
			if (_9e < _9f) {
				...
				if (_9e + n.outerHeight() > _9f + c.outerHeight() - 18) {
					c.scrollTop(c.scrollTop() + _9e + n.outerHeight() - _9f
							- c.outerHeight() + 18);
				}
			}
		} else {
	...
	function _b0(_b1, _b2) {
		...
		if (_b3) {
			if (!_b3.children || !_b3.children.length) {
				var _b4 = $(_b3.target);
				_b4.find(".tree-icon").removeClass("tree-folder")
						.addClass("tree-file");
	...
	function _f0(_f1, _f2) {
		...
		_f6.width(_f5 + 20);
		_f6.height(document.compatMode == "CSS1Compat" ? (18 - (_f6
				.outerHeight() - _f6.height())) : 18);
	...
	var _127 = {
		render : function(_128, ul, data) {
			...
			var _129 = $(ul).prev("div.tree-node")
			...
			function _12a(_12b, _12c) {
				...
				for (var i = 0; i < _12c.length; i++) {
					...
					cc.push("<span class=\"tree-title\">"
							+ opts.formatter.call(_128, item) + "</span>");
					cc.push("</div>");
					if (item.children && item.children.length) {
