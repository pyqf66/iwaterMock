...
(function($) {
	...
	function _17(_18) {
		...
		_1c.html("<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"
	...
	function _24(_25, _26) {
		...
		for (var i = 0; i < _26.length; i++) {
			...
			var _2e = $("<input type=\"hidden\" class=\"slider-value\">")
					.appendTo(_29);
			_2e.attr("name", _2c);
			_2e.val(_2d);
			_2b.push(_2d);
			...
			if (_28.mode == "h") {
				var _31 = "left:" + pos + "px;";
				_2f.attr("style", _31);
				tip.attr("style", _31 + "margin-left:"
	...
	function _22(_3a, pos) {
		...
		var pos = _3c.mode == "h"
				? (_3c.reversed ? (_3e - pos) : pos)
				: (_3c.reversed ? pos : (_3e - pos));
		...
		return this.each(function() {
					...
					if (_43.range) {
						if (!$.isArray(_43.value)) {
							_43.value = $.map(String(_43.value)
											.split(_43.separator), function(v) {
										return parseFloat(v);
									});
						}
	...
	$.fn.slider.methods = {
		...
		reset : function(jq) {
			return jq.each(function() {
						...
						$(this).slider(_48.range ? "setValues" : "setValue",
								_48.originalValue);
					});
		},
		enable : function(jq) {
	...
	$.fn.slider.parseOptions = function(_49) {
		var t = $(_49);
		return $.extend({}, $.parser.parseOptions(_49, ["width", "height",
								"mode", {
									reversed : "boolean",
									showTip : "boolean",
									range : "boolean",
